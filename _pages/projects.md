...
<div class="projects-list">
  <div class="project-item">
    <div class="project-heading">
      <div class="project-title">Emerging Tourism Area Monitoring System</div>
      <div class="project-period">2022.07 - 2022.08</div>
    </div>
    ...
    <div class="project-field">
      ...
      <span>Korea Tourism Organization (KTO)</span>
    </div>
    ...
    <div class="project-field">
      ...
      <span class="project-tech-list">
        ...
        <span class="project-tech">Spring</span>
        <span class="project-tech">JavaScript</span>
        <span class="project-tech">Tableau</span>
    ...
    <div class="project-field">
      ...
      <span>Planned the project, built a search-term dictionary for tourism data collection, automated web crawling and preprocessing, and implemented keyword frequency analysis.</span>
    </div>

    <div class="project-field">
      <span class="project-label">Outcome:</span>
      <span>Received a Presidential Commendation from the Korea Tourism Organization and Second Prize in the 2022 Korea Tourism Data Lab Contest.</span>
    </div>
  ...
  <div class="project-item">
    <div class="project-heading">
      <div class="project-title">Daon: Personalized Welfare Policy Platform</div>
      <div class="project-period">2022.09</div>
    </div>
    ...
    <div class="project-field">
      <span class="project-label">Role:</span>
      <span>Collected and cleaned welfare policy data, applied morphological analysis to search queries, and implemented similarity-based retrieval between user queries and policy documents.</span>
    </div>

    <div class="project-field">
      <span class="project-label">Outcome:</span>
      <span>Won First Prize at the 2022 Northeast Public Data Utilization Challenge.</span>
    </div>
